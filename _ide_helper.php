...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         * ("Client2-Ip" for instance), configure it via the $trustedHeaderSet
     ...
     */        class Response {
         ...
         *
         *
         * @see \App\Providers\AppServiceProvider::registerApiResponseMacro()
         * @param mixed $data
         * @param mixed $message
         * @param mixed $status
         * @param mixed $headers
         * @static
         */        public static function api($data = null, $message = '', $status = 200, $headers = [])
        {
                        return \Illuminate\Routing\ResponseFactory::api($data, $message, $status, $headers);
        }
            }
            /**
     *
