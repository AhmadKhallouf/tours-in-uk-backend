...
return [
    ...
    'title' => 'Pretty Tours backend API documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'This is the backend API for the Pretty Tours application. It provides all required endpoints for managing tours, VIP services, bookings, and users.',
